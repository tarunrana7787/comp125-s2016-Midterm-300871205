...
course- COMP125-s2016-MidTerm-300871205*/
...
(function () {
    ...
    ids[2] = document.getElementById('secondTitle');
    ids[3] = document.getElementById('content2');
    ids[4] = document.getElementById('thirdTitle');
    ids[5] = document.getElementById('content3');
    ids[6] = document.getElementById('fourthTitle');
    ids[7] = document.getElementById('content4');
    ids[8] = document.getElementById('fifthTitle');
    ids[9] = document.getElementById('content5');
    ids[10] = document.getElementById('sixthTitle');
    ids[11] = document.getElementById('content6');
    ids[12] = document.getElementById('seventhTitle');
    ids[13] = document.getElementById('content7');
    ids[14] = document.getElementById('eigthTitle');
    ids[15] = document.getElementById('content8');
    ids[16] = document.getElementById('ninthTitle');
    ids[17] = document.getElementById('content9');
    ids[18] = document.getElementById('tenthTitle');
    ids[19] = document.getElementById('content10');
